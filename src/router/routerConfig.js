      ...
      // forms
      {
        ...
        children: [
          ...
          },
          {
            path: '/form/step-form',
            name: 'StepForm',
            component: () => import(/* webpackChunkName: "StepForm" */ '@/views/form/stepForm/StepForm'),
            meta: {
          ...
          },
          {
            ...
            name: 'AdvanceForm',
            component: () => import(/* webpackChunkName: "advancedForm" */ '@/views/form/advancedForm/AdvancedForm'),
            meta: {
        ...
        children: [
          {
            ...
            component: () => import(/* webpackChunkName: "tableList" */ '@/views/list/TableList'),
            meta: {
          ...
          },
          {
            path: '/list/search',
            name: 'SearchList',
            component: () => import(/* webpackChunkName: "searchList" */ '@/views/list/search/SearchLayout'),
            ...
            children: [
              {
                ...
                name: 'SearchArticles',
                component: () => import(/* webpackChunkName: "searchArticles" */ '@/views/list/search/Article'),
                meta: {
              ...
              },
              {
                ...
                name: 'SearchProjects',
                component: () => import(/* webpackChunkName: "searchProjects" */ '@/views/list/search/Projects'),
                meta: {
              ...
              },
              {
                ...
                component: () => import(/* webpackChunkName: "searchApplications" */ '@/views/list/search/Applications'),
                meta: {
        ...
        children: [
          {
            path: '/profile/basic',
            name: 'ProfileBasic',
            component: () => import(/* webpackChunkName: "profileBasic" */ '@/views/profile/basic'),
            meta: {
          ...
          },
          {
            ...
            component: () => import(/* webpackChunkName: "profileAdvanced" */ '@/views/profile/advanced/Advanced'),
            meta: {
        ...
        children: [
          {
            path: '/result/success',
            name: 'ResultSuccess',
            component: () => import(/* webpackChunkName: "resultSuccess" */ '@/views/result/Success'),
            meta: {
          ...
          },
          {
            path: '/result/fail',
            name: 'ResultFail',
            component: () => import(/* webpackChunkName: "resultFail" */ '@/views/result/Error'),
            meta: {
        ...
        children: [
          {
            path: '/account/center',
            name: 'center',
            component: () => import(/* webpackChunkName: "accountCenter" */ '@/views/account/center'),
            meta: {
          ...
          },
          {
            ...
            name: 'settings',
            component: () => import(/* webpackChunkName: "accountSettings" */ '@/views/account/settings'),
            meta: {
            ...
            children: [
              {
                ...
                name: 'BasicSettings',
                component: () => import(/* webpackChunkName: "basicSettings" */ '@/views/account/settings/BasicSetting'),
                meta: {
              ...
              },
              {
                ...
                component: () => import(/* webpackChunkName: "securitySettings" */ '@/views/account/settings/Security'),
                meta: {
              ...
              },
              {
                ...
                name: 'CustomSettings',
                component: () => import(/* webpackChunkName: "customSettings" */ '@/views/account/settings/Custom'),
                meta: {
              ...
              },
              {
                ...
                component: () => import(/* webpackChunkName: "bindingSettings" */ '@/views/account/settings/Binding'),
                meta: {
              ...
              },
              {
                ...
                component: () => import(/* webpackChunkName: "notificationSettings" */ '@/views/account/settings/Notification'),
                meta: {
        ...
        children: [
          {
            ...
            name: 'TestIconSelect',
            component: () => import(/* webpackChunkName: "iconSelector" */ '@/views/other/IconSelectorView'),
            meta: {
              title: 'IconSelector',
              icon: 'tool',
              keepAlive: true,
            ...
            children: [
              {
                ...
                name: 'TreeList',
                component: () => import(/* webpackChunkName: "treeList" */ '@/views/other/TreeList'),
                meta: {
                  title: '树目录表格',
                  keepAlive: true
                }
              },
              {
                ...
                name: 'EditList',
                component: () => import(/* webpackChunkName: "editList" */ '@/views/other/TableInnerEditList'),
                meta: {
                  title: '内联编辑表格',
                  keepAlive: true
                }
